...
export default function MembershipTiersPage() {
  ...
  return (
    <main className="relative pb-24 pt-12 sm:pb-28">
      <section className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-14">
        <Reveal>
          <div className="max-w-4xl">
            ...
            <h1
              className={`${brandSerif.className} mt-6 text-4xl leading-[0.95] text-[#fffff0] sm:text-6xl lg:text-[4.5rem]`}
            >
